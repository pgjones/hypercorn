...
htmlhelp_basename = 'Hypercorndoc'
...
latex_documents = [
    (master_doc, 'Hypercorn.tex', 'Hypercorn Documentation',
     'Philip Jones', 'manual'),
]
...
man_pages = [
    (master_doc, 'hypercorn', 'Hypercorn Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'Hypercorn', 'Hypercorn Documentation',
     author, 'Hypercorn', 'One line description of project.',
     'Miscellaneous'),
]
